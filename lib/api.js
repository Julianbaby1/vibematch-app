...
// The API is served by the same Next.js deployment (pages/api/[[...path]].js),
// so requests default to same-origin. Set NEXT_PUBLIC_API_URL only when the
// Express server runs elsewhere (e.g. a separate Railway deployment).
